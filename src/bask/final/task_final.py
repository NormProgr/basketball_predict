...
from bask.final.plot import create_heatmap, generate_prediction_table, naive_inf_table
...
@pytask.mark.task
@pytask.mark.produces(BLD / "python" / "tables" / "basketball_pics_heatmap.pdf")
def task_create_results_pic_python(depends_on, produces):
    """Produce multiple descriptive graphs in pdf format based on the basketball data
    analysis.
    """
