...
\title{Scraping basketball data to predict future game outcomes\thanks{Norman Metzinger, Anne Rebecca Ringborg, University of Bonn. Email: \href{mailto:norman.metzinger@gmx.de}{\nolinkurl{norman [dot] metzinger [at] gmx [dot] de}}.}}

\author{Norman Metzinger, Anne Rebecca Ringborg}
